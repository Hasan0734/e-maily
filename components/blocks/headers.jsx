import { LogoWithCoverImageIcon } from "../editor/icons/logo-with-cover-image";
import { LogoWithTextHorizonIcon } from "../editor/icons/logo-with-text-horizon";
import { LogoWithTextVerticalIcon } from "../editor/icons/logo-with-text-vertical";

export const headerLogoWithTextHorizontal = {
  title: "Logo with Text (Horizontal)",
  description: "Logo and a text horizontally",
  searchTerms: ["logo", "text"],
  icon: <LogoWithTextHorizonIcon className="size-4" />,
...
export const headerLogoWithTextVertical = {
...
export const headerLogoWithCoverImage = {
